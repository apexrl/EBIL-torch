...
def experiment(variant):
    ...
    if variant['mode'] == 'deen':
        ebm_model = MLPEBM(
            ...
            sigma=variant['ebm_sigma']
        )
    else:
        raise NotImplementedError

    #TODO: Load EBM
    ebm_model.load(sigma=variant['ebm_sigma'], load_epoch=variant['energy_epoch'], state_only=variant['state_only'])
